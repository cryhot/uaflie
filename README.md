This is the code of **TLI-UA**, one of the four algorithms proposed in paper _"Uncertainty-Aware Signal Temporal Logic Inference"_:
...
To run **TLI-UA**, use the following command (see [command line arguments](#command-line-arguments) for more detail):

<code>./flie -sltl -f _file.trace_ [-max _formula-size_] [-vv]</code>

Note that <code>-min _robustness-margin_</code> has only been implemented in [TLI-UA-DT](https://github.com/cryhot/uaflie/tree/uaflie/TLI-UA-DT)
