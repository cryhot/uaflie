This is the code of **TLI-UA-DT**, one of the four algorithms proposed in paper _"Uncertainty-Aware Signal Temporal Logic Inference"_:
...
To run **TLI-UA-DT**, use the following command (see [command line arguments](#command-line-arguments) for more detail):

<code>./flie -sltl -f _file.trace_ [-max _formula-size_] [-min _robustness-margin_] [-vv]</code>
...
| -min \<robustness> | Specifies the minimal robustness margin the formula should have.
